    ...
    <>
      <Layout>
        <div className="account-appe-container payments-container">
          ...
          <GuardarCambios  />
          <p>Notifica a tus clientes cuando falla un pago. Este correo electrónico se envía solo en pagos únicos y pagos de activación de suscripción. Para enviar correos electrónicos cuando falla la renovación de una suscripción, haga clic <Link href="/account/settings/notifications/recovery-failed">aquí.</Link></p>
                ...
                <div className="order-box">
                  <p className="app-input input label-flex1">
                    ...
                    <label className="switch space-r">
                      <input type="checkbox" notification_id="payment_failed" id="activate" name="activate" value="1" />
              ...
              <div className="order-box-container">
                ...
                <div className="order-box">
                  ...
                  <div className="t_email-cont">
                    ...
                    <div>Tu pago ha fallado. Lastimosamente el método de pago utlizado ha sido rechazado. Te invitamos a revisar los detalles de tu método de pago e intentar el pago nuevamente.</div>
                    <div className="t_email-lbutton pago botones boton-violeta btn100">Volver a intentar el pago</div>
