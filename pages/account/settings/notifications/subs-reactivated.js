      ...
      <Layout>
        <div className="account-appe-container payments-container">
          <div className="order-head-paid">
            ...
            <h2>Suscripción reactivada</h2>
          </div>
          <GuardarCambios  />
          <p>Notifica a tus clientes cuando se reactive una suscripción, ya sea por ellos a través del portal de autoservicio o por ti a través del panel de administración.</p>
                ...
                <div className="order-box">
                  <p className="app-input input label-flex1">
                    ...
                    <label className="switch space-r">
                      <input type="checkbox" notification_id="subs_reactivated" id="activate" name="activate" value="1" />
              ...
              <div className="order-box-container">
                ...
                <div className="order-box">
                  ...
                  <div className="t_email-cont">
                    ...
                    <div>Tu suscripción #5710 se ha activado.</div>
                    <div className="t_email-border pago"></div>
                    <div className="t_email-lbutton botones boton-violeta btn100">Ver suscripción</div>
                  </div>
