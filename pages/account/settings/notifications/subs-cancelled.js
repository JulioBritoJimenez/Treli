    ...
    <>
      <Layout>
        <div className="account-appe-container payments-container">
          ...
          <GuardarCambios  />
          <p>Notifica a tus clientes cuando se cancela una suscripción, ya sea por ellos a través del portal de autoservicio o por ti a través del panel de administración.</p>
                ...
                <div className="order-box">
                  <p className="app-input input label-flex1">
                    ...
                    <label className="switch space-r">
                      <input type="checkbox" notification_id="subs_cancelled" id="activate" name="activate" value="1" />
              ...
              <div className="order-box-container">
                ...
                <div className="order-box">
                  ...
                  <div className="t_email-cont">
                    ...
                    <div>Tu suscripción #5710 se ha cancelado.</div>
                  </div>
...
export default SuscripcionCancelada;