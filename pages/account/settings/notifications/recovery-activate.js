...
function ActivacionSuscripcion() {
  return (
    <>
      <Layout>
                ...
                <div className="order-box">
                  <p className="app-input input label-flex1">
                    ...
                    <label className="switch space-r">
                      <input type="checkbox" notification_id="recovery-activate" id="activate" name="activate" value="1" />
              ...
              <div className="order-box-container">
                ...
                <div className="order-box">
                  ...
                  <div className="t_email-cont">
                    ...
                    <div>Completa el pago #5710 para activar tu suscripción.</div>
                    <div className="t_email-lbutton pago botones boton-violeta btn100">Completar el pago</div>
...
export default ActivacionSuscripcion;