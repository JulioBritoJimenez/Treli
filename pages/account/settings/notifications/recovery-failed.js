...
function RenovacionSuscripcionFallida() {
  return (
    <>
      <Layout>
              ...
              <div className="order-box-container">
                ...
                <div className="order-box">
                  ...
                  <div className="t_email-cont">
                    ...
                    <div className="margin-bottom-15px">El pago de renovación de tu suscripción ha fallado y esto indica que hay algún problema con el metodo de pago que tienes guardado.</div>
                    <div>Para reactivar tu suscripción, debes procesar el pago manualmente. Asegurate que la información del método de pago este actualizada.</div>
...
export default RenovacionSuscripcionFallida;